    ...
    for i, img_file in enumerate(image_files):
        ...
        try:
            ...
            if not guard_result.is_food:
                print(" DETECTED NON-FOOD (Skipped)")
                # Dump minimal info for observability but do not process further
            else:
                # Phase 2: Analysis
                ...
                # NEW: Passing "user_456" who has Celiac disease (Gluten allergy) in our mock DB
                safety_result = run_safety_check(meal_result, user_id="user_456")
